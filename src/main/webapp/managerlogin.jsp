...
.login-submit {
	...
	min-width: 1px;
	padding: .25rem;
	transition: 250ms background ease-in; &: hover , & : focus {
        background : white;
	color: black;
	transition: 250ms background ease-in;
}
...
<body>
	...
	%>
	<form action="managerlogin" method="post" class="login-form">
		...
		<input type="email" class="login-username" autofocus="true"
			...
			%>
			 ...
			 <input type="submit"
			name="Login" value="Login" class="login-submit" />
	</form>
	<a href="forgot.jsp" class="login-forgot-pass">forgot password?</a>
